...
namespace zks
{
    ...
    const std::array<u8string, simlog::Level::lsize> simlog::level_string = { { "EMERG", "FATAL", "ALERT", "CRIT", "ERROR", "WARN", "NOTICE", "INFO", "DEBUG",
            "TRACE" } };
    const std::array<u8string, simlog::Column::csize> simlog::column_string = { { "DATETIME", "EPOCHTIME", "THREAD", "FILE", "FUNC", "LINE", "GROUP", "LEVEL",
            "MESG" } };
