...
namespace zks {
	...
	public:
		...
		normal_iterator_() : _M_current(Iterator_()) { }
		explicit normal_iterator_(const Iterator_& __i) : _M_current(__i) { }
	...
	inline bool
		operator==(const normal_iterator_<IterLeft_, Container_>& __lhs,
	...
	template<typename Iterator_, typename Container_>
	inline bool
		operator==(const normal_iterator_<Iterator_, Container_>& __lhs,
	...
	// parameters.
	template<typename IterLeft_, typename IterRight_, typename Container_>
	inline typename normal_iterator_<IterLeft_, Container_>::difference_type
		operator-(const normal_iterator_<IterLeft_, Container_>& __lhs,
		const normal_iterator_<IterRight_, Container_>& __rhs)
	{
			return __lhs.base() - __rhs.base();
	...
	template<typename Iterator_, typename Container_>
	inline typename normal_iterator_<Iterator_, Container_>::difference_type
		operator-(const normal_iterator_<Iterator_, Container_>& __lhs,
		const normal_iterator_<Iterator_, Container_>& __rhs)
	{
			return __lhs.base() - __rhs.base();
	...
	template<typename Iterator_, typename Container_>
	inline normal_iterator_<Iterator_, Container_>
		operator+(typename normal_iterator_<Iterator_, Container_>::difference_type
		__n, const normal_iterator_<Iterator_, Container_>& __i)
	{
	...
	public:
		...
		forward_iterator_() : _M_current(Iterator_()) { }
		explicit forward_iterator_(const Iterator_& __i) : _M_current(__i) { }
	...
	template<typename IterLeft_, typename IterRight_, typename Container_>
	inline bool
		operator==(const forward_iterator_<IterLeft_, Container_>& __lhs,
	...
	template<typename Iterator_, typename Container_>
	inline bool
		operator==(const forward_iterator_<Iterator_, Container_>& __lhs,
	...
	// parameters.
	template<typename IterLeft_, typename IterRight_, typename Container_>
	inline typename forward_iterator_<IterLeft_, Container_>::difference_type
		operator-(const forward_iterator_<IterLeft_, Container_>& __lhs,
		const forward_iterator_<IterRight_, Container_>& __rhs)
	{
			return __lhs.base() - __rhs.base();
	...
	template<typename Iterator_, typename Container_>
	inline typename forward_iterator_<Iterator_, Container_>::difference_type
		operator-(const forward_iterator_<Iterator_, Container_>& __lhs,
		const forward_iterator_<Iterator_, Container_>& __rhs)
	{
			return __lhs.base() - __rhs.base();
	...
	template<typename Iterator_, typename Container_>
	inline forward_iterator_<Iterator_, Container_>
		operator+(typename forward_iterator_<Iterator_, Container_>::difference_type
		__n, const forward_iterator_<Iterator_, Container_>& __i)
	{
