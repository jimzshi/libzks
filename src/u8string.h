...
//helpers
         ...
         */
        inline bool validate(const char* s, size_t* pLen = nullptr)
        {
            return validate_range(s, s + std::char_traits<char>::length(s), pLen);
        }
        template<typename T_>
        bool invalid_codepoint(T_ cp)
        {
    ...
    public:
        ...
        u8_iterator_(u8_iterator_ const& p) :
                ptr_(p.ptr_), len_(p.len_)
        {
        }
        u8_iterator_(u8_iterator_ && p) :
                ptr_(std::move(p.ptr_)), len_(std::move(p.len_))
        {
        }
        ~u8_iterator_()
        {
    ...
    public:
        ...
        u8string(const char* s, size_type n) :
                u8string(s, 0, n)
        {
        }
        u8string(const char* s, size_type pos, size_type n)
        {
            assign(s, pos, n);
        }
        template<typename charT>
        explicit u8string(const charT* s)
        {
            assign(s, 0, npos);
        }
        template<typename charT>
        u8string(const charT* s, size_type n)
        {
            assign(s, 0, n);
        }
        template<typename charT>
        u8string(const charT* s, size_type pos, size_type n)
        {
            assign(s, pos, n);
        }

        template<typename charT>
        u8string(size_t size, charT c)
        {
            assign(size, c);
        }
        u8string(size_t size, const char* str)
        {
            assign(size, str);
        }
        u8string(u8string && rh)
        {
            assign(std::move(rh));
        }
        u8string(u8string const& s)
        {
            assign(s);
        }
        u8string(const u8string& str, size_type pos, size_type n = npos) :
                u8string(str.substr(pos, n))
        {
        }
        ...
        u8string(std::string const& s)
        {
            assign(s.data());
        }
        u8string(std::string&& s) :
                str_(std::move(s))
        {
            on_change_();
        }
...
#endif
        explicit u8string(std::wstring const& s)
        {
            operator=(s);
        }
        template<typename charT>
        explicit u8string(u8_iterator_<charT> const& i)
        {
            operator=(i);
        }
        ~u8string() = default;

        u8string& operator=(char c)
        {
            str_.resize(1);
            str_[0] = c;
            on_change_();
...
#endif
        u8string& operator=(wchar_t wc)
        {
            str_ = unicode::wcu8_cvt.to_bytes(wc);
            on_change_();
            return *this;
        }
        u8string& operator=(const char* cstr)
        {
            return assign(cstr);
        }
        ...
        u8string& operator=(u8string && u8s)
        {
            return assign(std::move(u8s));
        }
        u8string& operator=(std::string const& s)
        {
            return assign(s.c_str(), 0, s.size());
        }
        u8string& operator=(std::string&& s)
        {
            str_.assign(std::move(s));
            on_change_();
            return *this;
        }
#ifdef _HAS_CHAR_T_SUPPORT
...
#endif
        u8string& operator=(std::wstring const& ws)
        {
            str_ = unicode::wcu8_cvt.to_bytes(ws);
            on_change_();
            return *this;
        }
        //u8string& operator=(std::initializer_list<char> ilist) { operator=(u8string(ilist)); on_change_(); return *this; }
        template<typename charT>
        u8string& operator=(u8_iterator_<charT> const& i)
        {
            return assign(i.get(), 0, i.len());
        }
        ...
        u8_iterator u8_begin()
        {
            on_change_();
            return u8_iterator(&str_[0]);
        }
        const_u8_iterator u8_begin() const
        {
            return const_u8_iterator(&str_[0]);
        }
        const_u8_iterator u8_cbegin() const
        {
            return const_u8_iterator(&str_[0]);
        }
        u8_iterator u8_end()
        {
            on_change_();
            return u8_iterator(&str_[0] + str_.size());
        }
        const_u8_iterator u8_end() const
        {
            return const_u8_iterator(&str_[0] + str_.size());
        }
        const_u8_iterator u8_cend() const
        {
            return const_u8_iterator(&str_[0] + str_.size());
        }
        ...
        u8string& append(const char* s)
        {
            return append(s, npos);
        }
        u8string& append(char* s, size_type n)
        {
            return append((const char*) s, n);
        }
        u8string& append(char* s)
        {
            return append(s, npos);
        }

        u8string& append(size_type n, char c)
        {
            return append(u8string(n, c));
        }
#ifdef _HAS_CHAR_T_SUPPORT
        ...
        template<typename charT> //wchar_t, char16_t, char32_t;
        u8string& assign(const charT* s, size_type sz)
        {
            return assign(s, 0, sz);
        }
        template<typename charT> //wchar_t, char16_t, char32_t;
        u8string& assign(const charT* s)
        {
            return assign(s, 0, npos);
        }

        u8string& assign(size_type s, const char* str);  //cpp
        u8string& assign(size_type s, char c)
        {
            str_.assign(s, c);
            on_change_();
            return *this;
...
#endif
        u8string& assign(size_type s, wchar_t wc)
        {
            std::string u8 = unicode::wcu8_cvt.to_bytes(wc);
            return assign(s, u8.data());
        }
        u8string& assign(size_type s, u8string const& u8s)
        {
            return assign(s, u8s.data());
        }

        u8string& assign(u8string const& u8s)
        {
            str_.assign(u8s.str_);
            on_change_();
            return *this;
        }
        u8string& assign(u8string && u8s)
        {
            str_.assign(std::move(u8s.str_));
            on_change_();
            return *this;
        }
        u8string& assign(u8string const& u8s, size_t pos, size_t cnt)
        {
            assign(u8s.substr(pos, cnt));
            on_change_();
            return *this;
        }
        template<class InputIterator>
        ...
        //24.4.6.4 insert()
        u8string& insert(size_type index, char c)
        {
            on_change_();
            str_.insert(index, 1, c);
            return *this;
        }
        u8string& insert(size_type index, size_type count, char c)
        {
            on_change_();
            str_.insert(index, count, c);
            return *this;
        }
        u8string& insert(size_type index, size_type count, const char* str, size_type str_cnt);	//cpp
        u8string& insert(size_type index, const char* s, size_type cnt = size_type(-1))
        {
            return insert(index, 1, s, cnt);
        }
        u8string& insert(size_type index, u8string const& str)
        {
            on_change_();
            str_.insert(index, str.str_);
            return *this;
        }
        u8string& insert(size_type index, u8string const& str, size_type index_str, size_type count)
        {
        ...
        //21.4.6.5 erase()
        u8string& erase(size_type pos = 0, size_type n = npos)
        {
            str_.erase(pos, n);
            on_change_();
            return *this;
        ...
        //21.4.6.6 replace()
        u8string& replace(size_type pos1, size_type n1, const u8string& str)
        {
            str_.replace(pos1, n1, str.str_);
            on_change_();
            return *this;
        }
        u8string& replace(size_type pos1, size_type n1, const u8string& str, size_type pos2, size_type n2)
        {
            str_.replace(pos1, n1, str.str_, pos2, n2);
            on_change_();
            return *this;
        }
        u8string& replace(size_type pos, size_type n1, const char* s, size_type n2);	//cpp
        u8string& replace(size_type pos, size_type n1, const char* s)
        {
            return replace(pos, n1, s, npos);
        }
        u8string& replace(size_type pos, size_type n1, size_type n2, char c)
        {
            str_.replace(pos, n1, n2, c);
            on_change_();
            return *this;
        }
        u8string& replace(const_iterator i1, const_iterator i2, const u8string& str)
        {
            str_.replace(i1, i2, str.str_);
            on_change_();
            return *this;
        }
        u8string& replace(const_iterator i1, const_iterator i2, const char* s, size_type n)
        {
            return replace(i1 - cbegin(), i2 - i1, s, n);
        }
        u8string& replace(const_iterator i1, const_iterator i2, const char* s)
        {
            return replace(i1, i2, s, npos);
        }
        u8string& replace(const_iterator i1, const_iterator i2, size_type n, char c)
        {
        ...
        template<class InputIterator>
        u8string& replace(const_iterator i1, const_iterator i2, InputIterator j1, InputIterator j2)
        {
            return replace(i1, i2, u8string(j1, j2));
        }
#ifdef _HAS_CHAR_T_SUPPORT
        ...
        size_type find(const u8string& str, size_type pos = 0) const noexcept
        {
            return str_.find(str.str_, pos);
        }
        size_type find(const char* s, size_type pos, size_type n) const
        {
            return find(u8string(s, n), pos);
        }
        size_type find(const char* s, size_type pos = 0) const
        {
            return find(u8string(s), pos);
        }
        template<typename charT>
        size_type find(charT c, size_type pos = 0) const
        {
            return find(u8string(1, c), pos);
        }

        size_type rfind(const u8string& str, size_type pos = npos) const noexcept
        {
            return str_.rfind(str.str_, pos);
        }
        size_type rfind(const char* s, size_type pos, size_type n) const
        {
            return rfind(u8string(s, n), pos);
        }
        size_type rfind(const char* s, size_type pos = npos) const
        {
            return rfind(u8string(s), pos);
        }
        template<typename charT>
        size_type rfind(charT c, size_type pos = npos) const
        {
            return rfind(u8string(1, c), pos);
        }

        size_type find_first_of(const u8string& str, size_type pos = 0) const noexcept
        {
            return str_.find_first_of(str.str_, pos);
        }
        size_type find_first_of(const char* s, size_type pos, size_type n) const
        {
            return find_first_of(u8string(s, n), pos);
        }
        size_type find_first_of(const char* s, size_type pos = 0) const
        {
            return find_first_of(u8string(s), pos);
        }
        template<typename charT>
        size_type find_first_of(charT c, size_type pos = 0) const
        {
            return find_first_of(u8string(1, c), pos);
        }

        size_type find_last_of(const u8string& str, size_type pos = npos) const noexcept
        {
            return str_.find_last_of(str.str_, pos);
        }
        size_type find_last_of(const char* s, size_type pos, size_type n) const
        {
            return find_last_of(u8string(s, n), pos);
        }
        size_type find_last_of(const char* s, size_type pos = npos) const
        {
            return find_last_of(u8string(s), pos);
        }
        template<typename charT>
        size_type find_last_of(charT c, size_type pos = npos) const
        {
            return find_last_of(u8string(1, c), pos);
        }

        size_type find_first_not_of(const u8string& str, size_type pos = 0) const noexcept
        {
            return str_.find_first_not_of(str.str_, pos);
        }
        size_type find_first_not_of(const char* s, size_type pos, size_type n) const
        {
            return find_first_not_of(u8string(s, n), pos);
        }
        size_type find_first_not_of(const char* s, size_type pos = 0) const
        {
            return find_first_not_of(u8string(s), pos);
        }
        template<typename charT>
        size_type find_first_not_of(charT c, size_type pos = 0) const
        {
            return find_first_not_of(u8string(1, c), pos);
        }

        size_type find_last_not_of(const u8string& str, size_type pos = npos) const noexcept
        {
            return str_.find_last_not_of(str.str_, pos);
        }
        size_type find_last_not_of(const char* s, size_type pos, size_type n) const
        {
            return find_last_not_of(u8string(s, n), pos);
        }
        size_type find_last_not_of(const char* s, size_type pos = npos) const
        {
            return find_last_not_of(u8string(s), pos);
        }
        template<typename charT>
        size_type find_last_not_of(charT c, size_type pos = npos) const
        {
            return find_last_not_of(u8string(1, c), pos);
        }
        ...
        {
            return compare(u8string(s));
        }
        template<typename charT>
        int compare(size_type pos1, size_type n1, const charT* s) const
        {
            return u8string(*this, pos1, n1).compare(s);
        }
        template<typename charT>
        ...
        {
            return unicode::wcu8_cvt.from_bytes(str_);
        }
        bool is_valid() const
        {
            return unicode::validate(str_.data());
        }
        bool is_null() const
        {
            return empty();
        }
        bool startswith(u8string const& s) const
        {
            return (s.size() > size()) ? false : (compare(0, s.size(), s) == 0);
        }
        bool endswith(u8string const& s) const
        {
            return (s.size() > size()) ? false : (compare(size() - s.size(), s.size(), s) == 0);
        }
        u8string trim_left(u8string const& s) const;
        u8string trim_right(u8string const& s) const;
        u8string trim(u8string const& s) const
        {
...
#if _ZKS_U8STRING_INDEX
        size_type u8_size() const
        {
            update_();
            return index_.size() - 1;
        }
        size_type u8_length() const
        {
            return u8_size();
        }
        size_type u8_distance(size_type p1, size_type p2) const;
        size_type u8_distance(size_type p) const
        {
            return u8_distance(p, p + 1);
        }

        std::vector<size_type> const& u8_index() const
        {
            update_();
            return index_;
        }
        size_type u8_index(size_type n) const
        {
            update_();
            return index_[n];
        }
        size_type u8_index_last() const
        {
            return index_[u8_size() - 1];
        }
        u8_iterator u8_at(size_type n)
        {
            on_change_();
            return u8_iterator(&str_[u8_index(n)]);
        }
        const_u8_iterator u8_at(size_type n) const
        {
            return const_u8_iterator(&str_[u8_index(n)]);
        }
        const_u8_iterator u8_front() const
        {
            update_();
            return const_u8_iterator(&str_[0]);
        }
        const_u8_iterator u8_back() const
        {
            return const_u8_iterator(&str_[u8_index_last()]);
        }
        ...
        u8string& u8_truncate(size_type p)
        {
            return u8_erase(p, npos);
        }
    ...
    {
        return u8string(lhs).append(rhs);
    }
    inline u8string operator+(u8string&& lhs, const u8string& rhs)
    {
        return std::move(lhs.append(rhs));
    }
    inline u8string operator+(const u8string& lhs, u8string&& rhs)
    {
        return std::move(rhs.insert(0, lhs));
    }
    inline u8string operator+(u8string&& lhs, u8string&& rhs)
    {
        return std::move(lhs.append(rhs));
    }
//charT*
...
// 21.4.8.8, swap:
    ...
    inline std::istream& getline(std::istream& input, u8string& line, char del = '\n')
    {
        std::string tmp;
        std::getline(input, tmp, del);
        line = std::move(tmp);
        return input;
    }
